...
//
void send_expulsion(t_server *server, char** array, int id);
void send_expulsion_to_all(t_server *server, char** array);
//
void send_egg_laying_by_the_player(t_server *server, char** array, int id);
...
int *players);
//
void send_end_of_an_incantation(t_server *server, tmp_t co, int l, int id);
...
int x, int y);
//
void send_player_connection_for_an_egg(t_server *server, int);
...
//
void send_content_of_map(t_server *server, char **array, int id);
//
void send_con_of_new_player(t_server *server, t_client *player, int id);
//
void send_time_unit(t_server *server, char **message, int id);
//
